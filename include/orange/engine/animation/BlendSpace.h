                               ...
                               Scene::TransformComponent& pose)
{
    for (const AnimationTrack& track : clip.tracks)
    {
        ...
        switch (field)
        {
            case TransformTarget::Position:      pose.position = glm::vec3(v); break;
            case TransformTarget::PositionX:     pose.position.x = v.x; break;
            case TransformTarget::PositionY:     pose.position.y = v.x; break;
            case TransformTarget::PositionZ:     pose.position.z = v.x; break;
            ...
            case TransformTarget::RotationQuat:
                ...
                break;
            case TransformTarget::Scale:         pose.scale = glm::vec3(v); break;
            case TransformTarget::ScaleX:        pose.scale.x = v.x; break;
            case TransformTarget::ScaleY:        pose.scale.y = v.x; break;
            case TransformTarget::ScaleZ:        pose.scale.z = v.x; break;
            case TransformTarget::ScaleUniform:  pose.scale = glm::vec3(v.x); break;
