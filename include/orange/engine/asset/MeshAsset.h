...
namespace Orange::Engine::Asset
{
    ...
    public:
        ...
        MeshAsset(std::vector<VertexPosition3> positions, std::vector<std::uint32_t> indices)
            : mPositions(std::move(positions)), mIndices(std::move(indices))
        {
        }
        ...
        MeshAsset(std::vector<VertexPosition3> positions,
            ...
            : mPositions(std::move(positions)), mUVs(std::move(uvs)), mIndices(std::move(indices))
        {
        }
        ...
        MeshAsset(std::vector<VertexPosition3> positions,
                  ...
                  std::vector<std::uint32_t>   indices)
            : mPositions(std::move(positions)), mUVs(std::move(uvs)), mNormals(std::move(normals)), mIndices(std::move(indices))
        {
        }
