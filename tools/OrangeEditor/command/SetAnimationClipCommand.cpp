...
SetAnimationClipCommand::SetAnimationClipCommand(
    ...
    : mpHost(&host)
    , mEntity(entity)
    , mOldClip(std::move(oldClip))
    , mNewClip(std::move(newClip))
