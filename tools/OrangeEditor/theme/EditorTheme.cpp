...
namespace Orange::Editor::Theme
{
    ...
    namespace Color
    {
        ...
        {
            return kBackgroundPrimary;
        }
        const ImVec4& GetBackgroundSecondary()
        {
            return kBackgroundSecondary;
        }
        const ImVec4& GetBackgroundTertiary()
        {
            return kBackgroundTertiary;
        }
        ...
        {
            return kControlBgHovered;
        }
        const ImVec4& GetControlBgActive()
        {
            return kControlBgActive;
        }
        ...
        {
            return kHeaderBgHovered;
        }
        const ImVec4& GetHeaderBgActive()
        {
            return kHeaderBgActive;
        }
        ...
        {
            return kAccentHovered;
        }
        const ImVec4& GetAccentActive()
        {
            return kAccentActive;
        }
        const ImVec4& GetAccentSelection()
        {
            return kAccentSelection;
        }
        ...
        {
            return kAlertSuccess;
        }
        const ImVec4& GetPrefabOverride()
        {
            return kPrefabOverride;
        }
    ...
    namespace Icon
    {
        ...
        const char* GetPause()
        {
            return ICON_CI_DEBUG_PAUSE;
        }
        const char* GetStop()
        {
            return ICON_CI_DEBUG_STOP;
        }
        const char* GetClose()
        {
            return ICON_CI_CLOSE;
        }
        ...
        const char* GetArrowUp()
        {
            return ICON_CI_ARROW_UP;
        }
        const char* GetArrowDown()
        {
            return ICON_CI_ARROW_DOWN;
        }
        const char* GetFolder()
        {
            return ICON_CI_FOLDER;
        }
        const char* GetGear()
        {
            return ICON_CI_GEAR;
