...
namespace Orange::Editor::Schema
{
    ...
    template <>
    struct PropertyTypeOf<unsigned int>
    {
        static constexpr PropertyType value = PropertyType::UInt;
    };
    template <>
    ...
    template <>
    struct PropertyTypeOf<glm::quat>
    {
    ...
    template <>
    struct PropertyTypeOf<Orange::Engine::Entity>
    {
        static constexpr PropertyType value = PropertyType::EntityRef;
    };
    template <>
    struct PropertyTypeOf<Orange::Engine::Physics::PolygonDesc>
    {
        static constexpr PropertyType value = PropertyType::PolygonVertices;
    };
    template <>
    struct PropertyTypeOf<Orange::Engine::Physics::EdgeChainDesc>
    {
