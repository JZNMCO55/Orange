...
namespace
{
    ...
    bool IsDetachedRoot(World& world, Entity e)
    {
        ...
        return !h->parent.IsValid() && !h->prevSibling.IsValid() && !h->nextSibling.IsValid();
    }
    ...
    void TestMoveBeforeAfter()
    {
        ...
        { // 跨父定位：pA=[x]，pB=[t]，MoveBefore(x, t) → x 改挂 pB、在 t 前
            World  world;
            Entity pA = world.CreateEntity();
            world.AddComponent<HC>(pA, {});
            Entity pB = world.CreateEntity();
            world.AddComponent<HC>(pB, {});
            Entity x = world.CreateEntity();
            EditorHierarchy::LinkAsLastChild(world, pA, x);
            Entity t = world.CreateEntity();
            EditorHierarchy::LinkAsLastChild(world, pB, t);
    ...
    void TestIsAncestorOf()
    {
        ...
        World  world;
        Entity root = world.CreateEntity();
        world.AddComponent<HC>(root, {});
        Entity mid = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, root, mid);
        Entity leaf = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, mid, leaf);
        Entity sib = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, root, sib);
    ...
    void TestDestroySubtree()
    {
        ...
        Entity root = world.CreateEntity();
        world.AddComponent<HC>(root, {});
        Entity c1 = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, root, c1);
        Entity gc = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, c1, gc);
        Entity c2 = world.CreateEntity();
        EditorHierarchy::LinkAsLastChild(world, root, c2);
    ...
    void TestMoveRootRelative()
    {
        ...
        world.AddComponent<HC>(A, {});
        Entity B = world.CreateEntity();
        world.AddComponent<HC>(B, {});
        Entity C = world.CreateEntity();
        world.AddComponent<HC>(C, {});
        ...
        {
            World  w2;
            Entity only = w2.CreateEntity();
            w2.AddComponent<HC>(only, {});
