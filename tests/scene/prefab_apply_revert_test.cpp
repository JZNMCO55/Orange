...
namespace
{
    ...
    void TestApply()
    {
        ...
        assert(worldA.GetComponent<PrefabInstanceComponent>(instA)->templateEntityGuid == tmplEntityGuid);
        assert(worldB.GetComponent<PrefabInstanceComponent>(instB)->templateEntityGuid == tmplEntityGuid);
