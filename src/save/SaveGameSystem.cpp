                                             ...
                                             std::size_t         availableBytes)
{
    ...
    if (src[0] != static_cast<std::uint8_t>(kMagic[0])
     || src[1] != static_cast<std::uint8_t>(kMagic[1])
     || src[2] != static_cast<std::uint8_t>(kMagic[2])
     || src[3] != static_cast<std::uint8_t>(kMagic[3]))
    {
