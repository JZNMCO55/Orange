...
namespace Orange::Engine::Render
{
    ...
    {
        if (renderDevice == nullptr || sceneDepth == nullptr || hdrSampler == nullptr || godRaysPipeline == nullptr || bloomLayout == nullptr)
        {
            return false;
        }
    ...
    {
        if (offscreenCmd == nullptr || hdrColor == nullptr || sceneDepth == nullptr || godRaysPipeline == nullptr)
        {
            return false;
        }
        if (!EnsureGodRaysSet())
