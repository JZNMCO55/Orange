...
namespace Orange::Engine::Render
{
    ...
    {
        if (renderDevice == nullptr || sceneDepth == nullptr || hdrSampler == nullptr || ssaoPipeline == nullptr || ssaoApplyPipeline == nullptr || ssaoLayout == nullptr || bloomLayout == nullptr || ssaoUbo == nullptr)
        {
            return false;
        }
    ...
    bool Pipeline::Impl::RecordSsaoPass(const SsaoPass& ssaoDesc, const glm::mat4& proj)
    {
        ...
        // ---- Pass 1：ssao → ssaoColor ----
        {
            ...
            sc.mWidth  = ssaoColorWidth;
            sc.mHeight = ssaoColorHeight;
            cmd.SetScissor(sc);
