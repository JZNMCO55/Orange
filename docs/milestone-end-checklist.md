...
2. **acceptance-checklist 文档就位**（编辑器 milestone 必须；引擎 sample milestone 按需）
   - 编辑器 milestone：`docs/editor-v<X.Y>-acceptance-checklist.md` 必须存在且填完所有 commit 验收点
   - 沿用 `docs/editor-v0.2.5-acceptance-checklist.md` / `docs/editor-v0.3-acceptance-checklist.md` 格式
