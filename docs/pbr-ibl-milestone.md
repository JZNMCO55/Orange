...
- **状态**：✅（2026-05-18）—— Phase 6.5 整体完工，roadmap Task 06.5-01 ~ 07 全 ✅。起草于 2026-05-17，6 项 review 议题草稿期全部决议（见末尾决议记录）。**B.1 ✅（2026-05-18）**：Task PBR-01 / 02 / 03 落地（commits 753627e / edc783b / 0bc55c5 / 080ed8f / 97d4950 / 4fcabe0）；OrangeRender R1/R2/R3/R4 audit 同期 ✅（vendor bump 06025ae）。**B.2 ✅（2026-05-18）**：Task PBR-04 / 05 / 06 / 07 落地（commits f9c0e84 / eae6479 / f063829 / 89bee10 / bfb0087 / 6c823a2 / 736c253 / cf75126 / c9 收尾）；sample `14_pbr_ibl` + `Pipeline::BakeIblFromWorld` 高阶 API 完成端到端接通；B.1 / B.2 acceptance-checklist 落 `docs/acceptance/phase-6.5-B.{1,2}-acceptance-checklist.md`。v0.8 编辑器伴随 milestone（Environment 浏览 / material thumbnail / sky placeholder）在 `editor-roadmap.md` 立项
