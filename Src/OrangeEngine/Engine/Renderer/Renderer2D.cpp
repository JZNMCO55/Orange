...
namespace Orange
{
    ...
    void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color)
    {
        ...
        spData->mpTextureShader->SetFloat("u_TilingFactor", 1.0f);
    ...
    void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor)
    {
        ...
        spData->mpTextureShader->SetFloat4("u_Color", tintColor);
        spData->mpTextureShader->SetFloat("u_TilingFactor", tilingFactor);
        texture->Bind();
        glm::mat4 transform = glm::translate(glm::mat4(1.0f), position) * glm::scale(glm::mat4(1.0f), { size.x, size.y, 1.0f });
        spData->mpTextureShader->SetMat4("u_Transform", transform);
