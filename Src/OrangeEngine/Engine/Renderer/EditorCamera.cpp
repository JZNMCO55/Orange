...
namespace Orange
{
    ...
    {
        if (Input::IsKeyPressed(OrgKeyCodes::LeftAlt))
        {
            ...
            if (Input::IsMouseButtonPressed(ORG_MOUSE_BUTTON_MIDDLE))
                MousePan(delta);
            else if (Input::IsMouseButtonPressed(ORG_MOUSE_BUTTON_LEFT))
                MouseRotate(delta);
            else if (Input::IsMouseButtonPressed(ORG_MOUSE_BUTTON_RIGHT))
                MouseZoom(delta.y);
        }
    ...
    void EditorCamera::OnEvent(Event& e)
    {
        ...
        dispatcher.Dispatch<MouseScrolledEvent>(ORANGE_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
    }
