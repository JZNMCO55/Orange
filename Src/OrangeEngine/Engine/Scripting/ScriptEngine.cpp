...
namespace Orange
{
    ...
    void PrintAssemblyTypes(MonoAssembly* assembly)
    {
        ...
        for (int32_t i = 0; i < numTypes; i++)
        {
            ...
            ORANGE_LOG_TRACE("{}.{}", nameSpace, name);
        }
    }
    ...
    void ScriptEngine::InitMono()
    {
        ...
        ORANGE_CORE_ASSERT(rootDomain, "Failed to initialize the Mono runtime");
        ...
        // Move this maybe
        s_Data->CoreAssembly = LoadCSharpAssembly("../../Scripts/OrangeScript.dll");
