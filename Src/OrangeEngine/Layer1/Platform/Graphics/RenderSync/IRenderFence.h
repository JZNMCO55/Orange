...
namespace Orange
{
    namespace Graphics
    {
        ...
        public:
             ...
             * @return 围栏创建标志
             */
            virtual FenceCreateFlags GetFlags() const = 0;
        ...
        public:
             ...
             */
            virtual IRenderFence *CreateFence(const FenceCreateInfo &createInfo) = 0;

            /**
             * @brief 销毁围栏
             * @param fence 要销毁的围栏
             */
            virtual void DestroyFence(IRenderFence *fence) = 0;
             ...
             * @return 是否成功等待（超时返回false）
             */
            virtual bool WaitForFences(IRenderFence **fences, uint32_t fenceCount, bool waitAll, uint64_t timeout = UINT64_MAX) = 0;
             ...
             * @return 是否成功重置
             */
            virtual bool ResetFences(IRenderFence **fences, uint32_t fenceCount) = 0;
        };
