...
namespace Orange
{
    namespace Graphics
    {
        ...
        public:
             ...
             * @return 是否成功分配
             */
            virtual bool AllocateMemoryForBuffer(IBuffer *buffer, MemoryTypeFlags memoryTypeFlags = static_cast<MemoryTypeFlags>(MemoryTypeFlagBits::None)) = 0;
             ...
             * @return 是否成功分配
             */
            virtual bool AllocateMemoryForTexture(ITexture *texture, MemoryTypeFlags memoryTypeFlags = static_cast<MemoryTypeFlags>(MemoryTypeFlagBits::None)) = 0;

            /**
             * @brief 释放资源内存
             * @param resource 资源对象（IBuffer或ITexture）
             */
            virtual void FreeResourceMemory(void *resource) = 0;
             ...
             */
            virtual IMemoryAllocation *GetResourceAllocation(void *resource) const = 0;
             ...
             */
            virtual void GetBufferMemoryRequirements(IBuffer *buffer, MemoryRequirements &memReqs) const = 0;
             ...
             * @param memReqs 输出内存要求
             */
            virtual void GetTextureMemoryRequirements(ITexture *texture, MemoryRequirements &memReqs) const = 0;
        };
        ...
        public:
             ...
             * @return 资源内存分配器
             */
            virtual IResourceMemoryAllocator *GetResourceAllocator() const = 0;

            /**
             * @brief 获取缓冲区内存池
             * @return 缓冲区内存池
             */
            virtual IMemoryPool *GetBufferPool() const = 0;

            /**
             * @brief 获取图像内存池
             * @return 图像内存池
             */
            virtual IMemoryPool *GetImagePool() const = 0;

            /**
             * @brief 获取暂存内存池
             * @return 暂存内存池
             */
            virtual IMemoryPool *GetStagingPool() const = 0;
             ...
             */
            virtual IMemoryPool *CreatePool(const MemoryPoolCreateInfo &createInfo) = 0;

            /**
             * @brief 销毁内存池
             * @param pool 要销毁的内存池
             */
            virtual void DestroyPool(IMemoryPool *pool) = 0;
             ...
             * @param budget 输出预算信息
             */
            virtual void GetBudget(MemoryBudget &budget) const = 0;
             ...
             * @return 是否成功执行
             */
            virtual bool Defragment(const DefragmentationInfo &info, DefragmentationStats &stats) = 0;
        ...
        public:
             ...
             */
            virtual IMemoryManager *CreateMemoryManager(IRenderDevice *device, const MemoryManagerCreateInfo &createInfo) = 0;

            /**
             * @brief 销毁内存管理器
             * @param manager 要销毁的内存管理器
             */
            virtual void DestroyMemoryManager(IMemoryManager *manager) = 0;
        };
