...
namespace Orange
{
    namespace Graphics
    {
        ...
        public:
             ...
             * @return 内存池类型
             */
            virtual MemoryPoolType GetType() const = 0;
             ...
             */
            virtual IMemoryAllocation *Allocate(uint64_t size, uint64_t alignment = 16, const char *debugName = nullptr) = 0;
             ...
             * @return 内存类型标志
             */
            virtual MemoryTypeFlags GetMemoryTypeFlags() const = 0;
             ...
             * @return 是否支持碎片整理
             */
            virtual bool SupportsDefragmentation() const = 0;
        ...
        public:
             ...
             */
            virtual IMemoryPool *CreatePool(IMemoryAllocator *allocator, const MemoryPoolCreateInfo &createInfo) = 0;
            ...
            virtual IMemoryPool *CreateBufferPool(
                ...
                const char *debugName = "BufferPool") = 0;
            ...
            virtual IMemoryPool *CreateImagePool(
                ...
                const char *debugName = "ImagePool") = 0;
            ...
            virtual IMemoryPool *CreateStagingPool(
                ...
                const char *debugName = "StagingPool") = 0;
        };
