...
namespace Orange
{
    namespace Graphics
    {
        ...
        public:
             ...
             * @return 对齐大小（字节）
             */
            virtual uint64_t GetAlignment() const {}

            /**
             * @brief 获取内存类型
             * @return 内存类型标志
             */
            virtual MemoryTypeFlags GetMemoryType() const {}
             ...
             */
            virtual void *Map(MemoryMapFlags mapFlags = MemoryMapFlagBits::Read | MemoryMapFlagBits::Write) {}
             ...
             */
            virtual void FlushMappedRange(uint64_t offset = 0, uint64_t size = 0) {}
             ...
             * @param size 大小，0表示整个分配
             */
            virtual void InvalidateMappedRange(uint64_t offset = 0, uint64_t size = 0) {}
             ...
             * @return 原生内存句柄
             */
            virtual void *GetNativeMemory() const {}

            /**
             * @brief 获取所属分配器
             * @return 内存分配器
             */
            virtual class IMemoryAllocator *GetAllocator() const {}
             ...
             */
            virtual void SetPriority(MemoryPriority priority) {}
        };
        ...
        public:
             ...
             * @return 内存类型掩码
             */
            virtual uint32_t GetMemoryTypeMask(MemoryTypeFlags memoryTypeFlags) const {}
             ...
             * @return 内存类型标志
             */
            virtual MemoryTypeFlags GetMemoryTypeProperties(uint32_t memoryTypeIndex) const {}
             ...
             */
            virtual uint32_t FindMemoryType(uint32_t memoryTypeMask, MemoryTypeFlags memoryTypeFlags, bool requireExactFlags = false) const {}

            /**
             * @brief 获取内存预算信息
             * @param budget 输出预算信息
             */
            virtual void GetMemoryBudget(MemoryBudget &budget) const {}
             ...
             * @param userData 用户数据
             */
            virtual void SetOutOfMemoryCallback(void (*callback)(void *userData), void *userData) {}
             ...
             */
            virtual void CalculateResourceMemoryRequirements(const void *renderResourceDesc, MemoryRequirements &memReqs) const {}
        };
        ...
        public:
             ...
             */
            virtual IMemoryAllocator *CreateAllocator(IRenderDevice *device, const MemoryAllocatorCreateInfo &createInfo) {}

            /**
             * @brief 销毁内存分配器
             * @param allocator 要销毁的分配器
             */
            virtual void DestroyAllocator(IMemoryAllocator *allocator) {}
        };
