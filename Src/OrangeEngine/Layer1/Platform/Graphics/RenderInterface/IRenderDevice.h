...
namespace Orange
{
    namespace Graphics
    {
        ...
        public:
             ...
             */
            virtual void GetDeviceProperties(DeviceProperties &properties) const = 0;
             ...
             */
            virtual IRenderBuffer *CreateBuffer(const BufferCreateInfo &createInfo) = 0;
             ...
             */
            virtual IRenderTexture *CreateTexture(const TextureCreateInfo &createInfo) = 0;
             ...
             */
            virtual IRenderSampler *CreateSampler(const SamplerCreateInfo &createInfo) = 0;
             ...
             */
            virtual IShaderModule *CreateShaderModule(const ShaderCreateInfo &createInfo) = 0;
             ...
             */
            virtual IDescriptorSetLayout *CreateDescriptorSetLayout(const DescriptorSetLayoutCreateInfo &createInfo) = 0;
             ...
             */
            virtual IPipelineLayout *CreatePipelineLayout(const PipelineLayoutCreateInfo &createInfo) = 0;
             ...
             */
            virtual IRenderPipeline *CreateGraphicsPipeline(const GraphicsPipelineCreateInfo &createInfo) = 0;
             ...
             * @return 新创建的渲染管线指针，失败返回nullptr
             */
            virtual IRenderPipeline *CreateComputePipeline(const ComputePipelineCreateInfo &createInfo) = 0;
             ...
             */
            virtual IRenderPass *CreateRenderPass(const RenderPassCreateInfo &createInfo) = 0;
             ...
             */
            virtual IDescriptorPool *CreateDescriptorPool(const DescriptorPoolCreateInfo &createInfo) = 0;
             ...
             */
            virtual IFence *CreateFence(bool signaled = false) = 0;
             ...
             */
            virtual void GetMemoryStats(GPUMemoryStats &stats) const = 0;
             ...
             * @param name 调试名称
             */
            virtual void SetDebugName(void *object, uint32_t objectType, const char *name) = 0;
        };
