...
// =================================================================
    ...
    #else
        #define ORG_CORE_ASSERT_MESSAGE_INTERNAL(...)  ::Orange::Logger::PrintAssertMessage(::Orange::Logger::Type::Core, "Assertion Failed" __VA_OPT__(,) __VA_ARGS__)
        #define ORG_ASSERT_MESSAGE_INTERNAL(...)  ::Orange::Logger::PrintAssertMessage(::Orange::Logger::Type::Client, "Assertion Failed" __VA_OPT__(,) __VA_ARGS__)
    #endif
     ...
     * @param ... 可选的断言消息
     */
    #define ORG_CORE_ASSERT(condition, ...) { if(!(condition)) { ORG_CORE_ASSERT_MESSAGE_INTERNAL(__VA_ARGS__); ORG_DEBUG_BREAK; } }
     ...
     * @param ... 可选的断言消息
     */
    #define ORG_ASSERT(condition, ...) { if(!(condition)) { ORG_ASSERT_MESSAGE_INTERNAL(__VA_ARGS__); ORG_DEBUG_BREAK; } }
...
// =================================================================
    ...
    #else
        #define ORG_CORE_VERIFY_MESSAGE_INTERNAL(...)  ::Orange::Logger::PrintAssertMessage(::Orange::Logger::Type::Core, "Verify Failed" __VA_OPT__(,) __VA_ARGS__)
        #define ORG_VERIFY_MESSAGE_INTERNAL(...)  ::Orange::Logger::PrintAssertMessage(::Orange::Logger::Type::Client, "Verify Failed" __VA_OPT__(,) __VA_ARGS__)
    #endif
     ...
     */
    #define ORG_CORE_VERIFY(condition, ...) { if(!(condition)) { ORG_CORE_VERIFY_MESSAGE_INTERNAL(__VA_ARGS__); ORG_DEBUG_BREAK; } }
     ...
     * @param ... 可选的验证失败消息
     */
    #define ORG_VERIFY(condition, ...) { if(!(condition)) { ORG_VERIFY_MESSAGE_INTERNAL(__VA_ARGS__); ORG_DEBUG_BREAK; } }
